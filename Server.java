...
public class Server {
    ...
    private static class serverThread extends Thread {
        ...
        public void run() {
            final String pathname = "C:\\Users\\41410\\Desktop\\123";    //change into your own.
            //The file sent from the client will be stored here.
            final String retrievePath = "C:\\Users\\41410\\Desktop\\456"; //change into your own.
                ...
                do {
                    ...
                    if(input.equals("create")) {
                        ...
                        if(lockers.isEmpty()) {
                            ...
                            out.println("---------------------------------");
                            out.println("total locker number: "+lockers.size());
                            for (String s : lockers.keySet()) {
                                out.println("locker "+s+":");
                                MyLocker temp = lockers.get(s);
                                out.println("file number in locker "+temp.files.size());
                                out.println("current locker size: "+temp.getcurrLockerSize());
                                out.println("current dedup ratio: "+temp.getDedupRatio()+"%");
                                int ii=1;
                                for(MyFile f:lockers.get(s).files) {
                                    out.println("      file "+ii+": "+f.getmyFileName());
                                    out.println("      size: "+f.getSize());
                                    ii++;
                                }
                            }
                            out.println("end");
